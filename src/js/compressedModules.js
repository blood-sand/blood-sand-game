...
modules.testSubModule = function () {
        this.modules = {
        share: {},
        fetch: function (name) {
            let m = new modules[name];
...
modules.skills.prototype.hook.comms=function() {
    ...
    modules.testSubModule.prototype.state = waject();
    modules.testSubModule.prototype.share = modules.share;
    modules.testSubModule.prototype.loaded = false;
