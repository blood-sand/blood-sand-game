...
window.modules.navigation.prototype.modules.gladiator.prototype.modules.combatStats.prototype.display.box=$("<!--Combat Stats Start--> <div id=\"combatStats\" class=\"item\"> <!--Name Start--> <span> Combat Statistics For <input name=\"name\" value=\"Name Your Gladiator\"> </span> <!--Name End--> <!--Data Start--> <ul class=\"gladiatorData\"> <li title=\"Affected by endurance, lifestyle, rank, vitality, weight, and willpower.\"> <span>Health</span> <input type=\"number\" class=\"stat\" name=\"health\" readonly> </li> <li title=\"Affected by endurance, lifestyle, rank, vitality, willpower.\"> <span>Stamina</span> <input type=\"number\" class=\"stat\" name=\"stamina\" readonly> </li> <li> <span>Stamina Recovery</span> <input type=\"number\" class=\"stat\" name=\"staminaRecovery\" readonly> </li> <li> <span>Initiative</span> <input type=\"number\" class=\"stat\" name=\"initiative\" readonly> </li> <li> <span>Nerve</span> <input type=\"number\" class=\"stat\" name=\"nerve\" readonly> </li> <li> <span>Offense</span> <input type=\"number\" class=\"stat\" name=\"offense\" readonly> </li> <li> <span>Defense</span> <input type=\"number\" class=\"stat\" name=\"defense\" readonly> </li> <li> <span>Dodge</span> <input type=\"number\" class=\"stat\" name=\"dodge\" readonly> </li> <li> <span>Parry</span> <input type=\"number\" class=\"stat\" name=\"parry\" readonly> </li> </ul> <!--Data End--> </div> <!--Combat Stats End--> ");
window.modules.navigation.prototype.modules.gladiator.prototype.modules.combatStats.prototype.display.style="/* CSS Start */ /* Display */ div > button[name=\"combatStatsNext\"] { display: block; } button[name=\"combatStatsPrevious\"] { display: block; float: left; } #combatStats input[name=\"name\"] { width: 50%; } #combatStats select { width: 150px; } button[name=\"combatStatsNext\"] { display: block; float: right; } /* CSS End */ ";
...
window.modules.navigation.prototype.modules.gladiator.prototype.modules.culture.prototype.display.box=$("<!--Culture Start--> <div id=\"culture\" class=\"item\"> <!--Name Start--> <span> <img title=\"Randomly Generate Culture, Sex and Name.\" src=\"/img/dice.png\" class=\"randomizeCulture dice\"> Culture of <input name=\"name\" placeholder=\"Name This Fighter\"> </span> <!--Name End--> <!--Data Start--> <ul class=\"gladiatorData\"> <li> <span>Culture</span> <select class=\"stat\" name=\"culture\"> <option>roman</option> <option>gallic</option> <option>germanic</option> <option>syrian</option> <option>numidian</option> <option>thracian</option> <option>greek</option> <option>iberian</option> <option>judean</option> <option>scythian</option> </select> </li> <li> <span>Sex</span> <select class=\"stat\" name=\"sex\"> <option>male</option> <option>female</option> </select> </li> <li> <span> Name <img title=\"Randomly Generate a name based on The Fighter's Culture and Sex.\" src=\"/img/dice.png\" class=\"randomizeName dice\"> </span> <input class=\"stat\" name=\"name\"> </li> </ul> <!--Data End--> </div> <!--Culture End--> ");
window.modules.navigation.prototype.modules.gladiator.prototype.modules.culture.prototype.display.style="/* CSS Start */ /* Display */ div > button[name=\"cultureNext\"] { display: block; } #culture input[name=\"name\"] { width: 450px; } button[name=\"cultureNext\"] { display: block; float: right; } /* CSS End */ ";
...
window.modules.navigation.prototype.modules.gladiator.prototype.modules.skills.prototype.hook.comms=function() {
	...
	/**
	 * @description Tactics calculation
	 * @author Luca Cattide
	 * @date 2019-10-20
	 * @param {number} val Tactic value
	 * @returns
	 */
